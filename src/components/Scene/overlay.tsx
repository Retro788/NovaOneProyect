      ...
      <div className="absolute bottom-0 right-0">
        <div className="flex flex-col">
          <div className=" *:text-xs flex flex-row space-x-3 p-2 text-neutral-50/50">
            <a className="text-neutral-50/50 hover:text-orange-500 cursor-pointer" href="https://github.com/Retro788" target="_blank">RetroTheDev</a>
            <p>|</p>
            <a className="text-neutral-50/50 hover:text-orange-500 cursor-pointer"  target="_blank">Solar Seismic Simulator</a>
            <p>|</p>
          </div>
        </div>
      </div>
      <div className="absolute top-0">
        {/* <div className="flex flex-row justify-between" > */}
          <div className="w-full select-none m-3 text-neutral-50">
            ...
            <a className="fill-neutral-50 hover:fill-orange-500 cursor-pointer" href="https://github.com/Retro788" target="_blank">{svgLogo}</a>
